	...
	<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
				...
				<li class="active">Важна Обавештења</li>
			</ol>
		</div>
	</div>
<!-- //breadcrumbs -->
	<div class="container">
		...
		<!-- //btm-wthree-left -->
			...
			<div class="agileits_heading_section">
				<h3 class="wthree_head"><span style="color:red">Важна Обавештења</span></h3>
				<p class="agileinfo_para"><span style="color:red">Овде можете погледати Важна Обавештења.</span></p>
			</div>
				<?php if(isset($reports)): ?>
					<ul style="margin-top:100px;">
						<?php foreach($reports as $r): ?>
							<li><label><?php echo $r->title; ?></label> <?php echo $r->pdf ? "<a href='" . base_url() . "podaci/" .$r->pdf ."'>...Preuzmi pdf fajl</a>" : "<a href='" . base_url() . "podaci/" .$r->excell ."'>...Преузми ворд или ексел фајл</a>" ?></li><hr>
						<?php endforeach; ?>
					</ul>
				<?php endif; ?>
			</div>
