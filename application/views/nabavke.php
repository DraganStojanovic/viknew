	...
	<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
				...
				<li class="active">Јавне Набавке</li>
			</ol>
		</div>
	</div>
<!-- //breadcrumbs -->
	<div class="container">
		...
		<!-- //btm-wthree-left -->
			...
			<div class="agileits_heading_section">
				<h3 class="wthree_head">Јавне Набавке</h3>
				<p class="agileinfo_para">Овде можете преузети фајлове актуелних јавних набавки.</p>
				<div class="form-group" style="margin-top:20px;">
					<select onchange="location = this.value;" class="form-control" name="">
						<option value="0">Odabrati kategoriju nabavke...</option>
						<?php foreach($kategorije as $kat): ?>
							<option value="<?php echo base_url(); ?>nabavke/index/<?php echo $kat->id; ?>"><?php echo $kat->name; ?></option>
						<?php endforeach; ?>
					</select>
				</div>
			</div>
